...
<title>Raheja Lunaris Luxurious 2 BHK Flats in Vashi, Mumbai</title>
<meta name="description" content="Raheja Lunaris in Vashi, Mumbai. Luxurious Residential Project by Raheja Universal Offering 2 BHK Flats. Check Property Price, Floor Plans & Amenities">
<link rel="canonical" href="https://www.rahejaslunarisjuinagar.com/">
...
<link
  rel="preload"
  as="image"
  href="./assets/img/deskban1.webp"
  media="(min-width: 769px)"
  fetchpriority="high"
  imagesrcset="./assets/img/deskban1.webp"
>

<link
  rel="preload"
  as="image"
  href="./assets/img/mobban1.webp"
  media="(max-width: 768px)"
  fetchpriority="high"
  imagesrcset="./assets/img/mobban1.webp"
>
...
:root{
  --colorPrimary:#ab1c11;
  --colorSecondary:#4f1539;
  --colorBtn:#ffffff;

  /* restored from old CSS */
  --bgDesk:url('../img/deskban1.webp');
  --bgMob:url('../img/mobban1.webp');
}
    ...
    <body data-spy="scroll" data-target="#navbarNav">
      ...
      <header class="micro-nav fixed-top pload">
            <nav class="navbar navbar-expand-lg navbar-light bg-white micro-navbar">
                <a class="navbar-brand" href="/" ><img alt="Raheja Lunaris Logo" src="./assets/img/logo.svg" class="logo" /></a>
...
<main class="pload">
 ...
 <style>
  ...
  <section class="section shadow-sm lazyload" id="developer">
    <div class="d-block pt-2 pb-1 text-center" style="padding-top:70px !important;"><img src="./assets/img/thanks-icon.webp" alt="Thank You Icon" loading="lazy" style="max-width: 100%; height: 100px;  display: inline-block;" /></div>
    <div style="text-align: center;">
    <span><h1>You're All Set!</h1></span>
    <span class="d-block section-heading-sub text-capitalize">Greetings From Raheja Lunaris</span>
    <div class="thankyou-text"><p>Thanks you for expressing interest on our website.<br>Our expert will get in touch with you shortly.</p></div>
    <a class="thank-you-brochure" target="_NEW" href="./assets/brochure.pdf">
    <button class="btn btn-sm btn-info micro-form-btn-sm effetGradient effectScale enqModal mt-1" data-form="sm" style="font-size:16px; padding: 9px 24px;" onclick="./assets/brochure.pdf" >Download Brochure</button></a>
   
    </div>
    <form><input type="hidden" id="hbemail" name="hbemail" value="" class="hbemailclass" ></form>
</section>
</main>
...
@media (min-width: 320px) and (max-width: 767px)  {
            ...
            <div class="micro-side text-center">
                <div class="og-section pb-2">
                    <ul class="nav nav-fill og-block">
                        ...
                        <li class="nav-item driftc d-flex-center-items"> <a href="tel:70219 89706" class="textcolor d-flex-center-items"><i class="mi mi-call"></i> 70219 89706</a></li>   
                    </ul>
                    <button
                ...
                <form action="thank-you.php" method="post" class="form-side" id="pardotForm" class="pardotForm">
                    ...
                    <input type="hidden" id="project" name="project" value="Raheja Lunaris">
                    <input type=hidden id="lead_source" name="lead_source" value="Microsite">
                    <input type="hidden" name=ip id="ip" value="106.222.210.242">
                    ...
                    <input type="hidden" name="home_url" value="https://www.rahejaslunarisjuinagar.com/thank-you.php">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <div class="d-flex">
                                <div class="flex-fill align-self-center flex-shrink-1 modal-highlight-bg d-none d-lg-block popbox-left">
                                    <div class="poplogo-box"><span class="popup-logo"><img alt="Raheja Lunaris Logo" src="./assets/img/logo.svg" class="poplogo"></span></div>
                                ...
                                <div class="flex-fill popbox-right">
                                    <div class="modal-head d-none"><span class="modal-title"> Download Brochure</span></div>
                                    <div class="poplogo-box desktop"><span class="popup-logo"><img alt="Raheja Lunaris Logo" src="./assets/img/logo.svg" class="poplogo logo"></span></div>
    ...
    <!--CONTACT NO-->
            <a href="tel:70219 89706" aria-label="Contact No." class="popcallbtn modal-call-btn d-block" style="padding: 0.5rem 1rem;"><i class="mi mi-call"></i> 70219 89706</a>
            ...
            <div class="download-brochure">
                <div class="desk_brochure">
                    <a
                        ...
                        data-target="#enqModal">
                        <img
  src="./assets/img/brochure_icon_n1.webp"
...
>
                ...
                <div class="mob_brochure">
                    <a
                        ...
                        data-target="#enqModal">
                        <img
  src="./assets/img/brochure_icon_mob_n1.webp"
  alt="Download brochure"
  width="83"
  height="252"
  loading="lazy"
       ...
       <!-- Start of Async Drift Code --> 
        ...
        <div class="col-md-4"><button class="btn btn-info micro-form-btn enqModal effetMoveGradient effectScale float-lg-right mx-sm-auto  d-none d-lg-block" data-form="lg" data-title="Get Directions" data-btn="Send Now" data-enquiry="Get Directions" data-redirect="floorplan" data-toggle="modal" data-target="#enqModal">Get Directions</button></div></div>
                    <div class="row mb-3"> 
                        ...
                        <div class="row"> 
                        <div class="col loc-pointer loc-pointer-first"><div class="loc-text"><i class="mi mi-loc-list-2 color-primary loc-icon"></i> <span>Thane Belapur Road </span> </div><span class="text-right">1 min</span></div> 
                        <div class="col loc-pointer"><div class="loc-text"><i class="mi mi-loc-list-2 color-primary loc-icon"></i> <span>Sion Panvel Highway </span></div> <span class="text-right">2 min</span></div> 
                        <div class="col loc-pointer"><div class="loc-text"><i class="mi mi-loc-list-2 color-primary loc-icon"></i> <span>Juinagar Railway Station </span> </div><span class="text-right">2 min</span></div> 
                    </div> 
                        </div>
                    </div> 
...
function bindFormSubmit() {
  ...
  $('form#pardotForm').off('submit').on('submit', function (e) {
    ...
    function submitWithDeviceId(deviceId) {
      ...
      // Submit safely by redirecting locally (keeping the site unconnected)
...
<!-- WhatsApp Float -->
<a href="https://wa.me/917021989706?text=Hi%21%20I%20would%20like%20to%20know%20more%20about%20Raheja%20Lunaris." class="whatsapp-float" style="position:fixed;width:60px;height:60px;bottom:20px;right:20px;background-color:#25d366;color:#FFF;border-radius:50px;text-align:center;font-size:30px;box-shadow: 2px 2px 3px #999;z-index:999999;display:flex;align-items:center;justify-content:center;" target="_blank" aria-label="Chat on WhatsApp">
